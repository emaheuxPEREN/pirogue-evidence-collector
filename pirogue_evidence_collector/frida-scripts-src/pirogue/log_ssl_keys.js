 ...
 *
 * Standalone usage (outside of pirogue-evidence-collector / testing purpose) can easily be achieved with:
 * $ frida -U -f com.example -l ./pirogue_evidence_collector/frida-scripts/log_ssl_keys.js --pause
